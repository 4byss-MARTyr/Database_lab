...
INSERT INTO book(cod, new, name, price, publisher, pages, format, datee, circulation, topic, category) VALUES
...
/*Створення зовнішніх ключів для полів publisher, topic, category*/
ALTER TABLE books ADD FOREIGN KEY(publisher) REFERENCES publisher(id) ON DELETE CASCADE;
ALTER TABLE books ADD FOREIGN KEY(topic) REFERENCES topic(id) ON DELETE CASCADE;
ALTER TABLE books ADD FOREIGN KEY(category) REFERENCES category(id) ON DELETE CASCADE;